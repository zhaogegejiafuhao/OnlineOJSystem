...
public class TeamController {
    ...
    private boolean isUserPermitted(Long tid, Integer require_level) {
        ...
        if (teammate == null) {
            throw new ForbiddenException("User is not in the team");
        }
    ...
    public String deleteTeammate(@PathVariable(value = "id") Long id) {
        ...
        if (selfTeammate == null) {
            throw new ForbiddenException("User is not in the team");
        }
        if (selfTeammate.getLevel() >= teammate.getLevel())
            throw new ForbiddenException("Cannot delete teammate with equal or higher level");
